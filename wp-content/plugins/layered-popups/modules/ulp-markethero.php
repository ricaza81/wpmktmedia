								...
								<table style="min-width: 280px; width: 50%;">
									<tr>
										...
										<td>
											...
											<br /><em>'.__('Lead email address.').'</em>
										</td>
									</tr>
									<tr>
										<td style="width: 100px;"><strong>'.__('First Name').':</strong></td>
										<td>
											...
											<br /><em>'.__('Lead first name.').'</em>
										</td>
									</tr>
									<tr>
										<td style="width: 100px;"><strong>'.__('Last Name').':</strong></td>
										<td>
