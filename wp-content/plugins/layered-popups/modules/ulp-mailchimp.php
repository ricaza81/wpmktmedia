...
class ulp_mailchimp_class {
	...
	function popup_options_show($_popup_options) {
		...
		echo '
							...
							<a class="ulp-button ulp-button-small" onclick="return ulp_mailchimp_loadfields(this);"><i class="fa fa-check"></i><label>'.__('Load Fields', 'ulp').'</label></a>
		...
		echo '
							...
							<a class="ulp-button ulp-button-small" onclick="return ulp_mailchimp_loadgroups(this);"><i class="fa fa-check"></i><label>'.__('Load Groups', 'ulp').'</label></a>
