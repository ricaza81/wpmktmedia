		...
		if (!defined('UAP_CORE')) {
			echo '
					...
					<tr>
						<th></th>
						<td>
							<a class="ulp-button ulp-button-small" onclick="return ulp_reset_settings(this);"><i class="fa fa-close"></i><label>'.__('Reset Settings', 'ulp').'</label></a>
	...
	function admin_popups() {
		...
		echo '
			<div class="wrap admin_ulp_wrap">
				...
				<div class="ulp_buttons"><a href="'.admin_url('admin.php').'?page=ulp-add" class="ulp-button ulp-button-small"><i class="fa fa-plus"></i><label>Create New Popup</label></a></div>
			...
			foreach ($rows as $row) {
				...
				<tr>
					...
					<td class="ulp-popups-actions">
						<a target="ulp-preview" href="'.$preview_url.'" title="'.__('Preview popup', 'ulp').'"><i class="fa fa-window-maximize"></i></a>
						<a href="'.admin_url('admin.php').'?page=ulp-add&id='.$row['id'].'" title="'.__('Edit popup details', 'ulp').'"><i class="fa fa-pencil"></i></a>
						<a href="'.admin_url('admin.php').'?action=ulp-copy&id='.$row['id'].'&ac='.$ulp->random_string().'" title="'.__('Duplicate popup', 'ulp').'" onclick="return ulp_confirm_redirect(this, \'duplicate\');"><i class="fa fa-copy"></i></a>
						<a href="'.admin_url('admin.php').'?action=ulp-export&id='.$row['id'].'&ac='.$ulp->random_string().'" title="'.__('Export popup details', 'ulp').'"><i class="fa fa-sign-out"></i></a>
						'.($export_full ? '<a href="'.admin_url('admin.php').'?action=ulp-export-full&id='.$row['id'].'&ac='.$ulp->random_string().'" title="'.__('Export full popup details (including images)', 'ulp').'"><i class="fa fa-download"></i></a>' : '').'
						'.($row['blocked'] == 1 ? '<a href="'.admin_url('admin.php').'?action=ulp-unblock&id='.$row['id'].'&ac='.$ulp->random_string().'" title="'.__('Unblock popup', 'ulp').'"><i class="fa fa-plus-square"></i></a>' : '<a href="'.admin_url('admin.php').'?action=ulp-block&id='.$row['id'].'&ac='.$ulp->random_string().'" title="'.__('Block popup', 'ulp').'"><i class="fa fa-minus-square"></i></a>').'
						<a href="'.admin_url('admin.php').'?action=ulp-drop-counters&id='.$row['id'].'&ac='.$ulp->random_string().'" title="'.__('Drop counters', 'ulp').'" onclick="return ulp_confirm_redirect(this, \'reset-stats\');"><i class="fa fa-eraser"></i></a>
						'.($ulp->ext_options['log_data'] == 'on' ? '<a href="'.admin_url('admin.php').'?page=ulp-subscribers&pid='.$row['id'].'" title="'.__('View log', 'ulp').'"><i class="fa fa-list"></i></a>' : '').'
						<a href="'.admin_url('admin.php').'?action=ulp-delete&id='.$row['id'].'&ac='.$ulp->random_string().'" title="'.__('Delete popup', 'ulp').'" onclick="return ulp_confirm_redirect(this, \'delete\');"><i class="fa fa-trash"></i></a>
					</td>
				</tr>';
			}
		} else {
		...
		echo '
				...
				<div class="ulp_buttons">
					...
					<a class="ulp-button ulp-button-small" onclick="jQuery(\'#ulp-import-form-file\').click(); return false;"><i class="fa fa-upload"></i><label>Import Popup</label></a>
					<a href="'.admin_url('admin.php').'?page=ulp-add" class="ulp-button ulp-button-small"><i class="fa fa-plus"></i><label>Create New Popup</label></a>
				</div>
				<div class="ulp_pageswitcher">'.$switcher.'</div>
			</div>';
		echo $ulp->admin_modal_html();
...
/*			echo '
	...
	function admin_campaigns() {
		...
		echo '
			<div class="wrap admin_ulp_wrap">
				...
				<div class="ulp_buttons"><a href="'.admin_url('admin.php').'?page=ulp-add-campaign" class="ulp-button ulp-button-small"><i class="fa fa-plus"></i><label>Create New Campaign</label></a></div>
				<div class="ulp_pageswitcher">'.$switcher.'</div>
				<table class="ulp_records">
				<tr>
					<th>'.__('Title', 'ulp').'</th>
		...
		if (sizeof($rows) > 0) {
			foreach ($rows as $row) {
				...
				<tr>
					...
					'.($ulp->ext_options['count_impressions'] == 'on' ? '<td style="text-align: right;">'.intval($row['impressions']).'</td>' : '').'
					<td class="ulp-popups-actions">
						<a href="'.admin_url('admin.php').'?page=ulp-add-campaign&id='.$row['id'].'" title="'.__('Edit campaign details', 'ulp').'"><i class="fa fa-pencil"></i></a>
						<a class="thickbox" href="'.admin_url('admin.php').'?action=ulp-campaigns-stats&id='.$row['id'].'&ac='.$ulp->random_string().'" title="'.__('Statistics', 'ulp').': '.esc_html($row['title']).'"><i class="fa fa-bar-chart"></i></a>
						'.($row['blocked'] == 1 ? '<a href="'.admin_url('admin.php').'?action=ulp-campaigns-unblock&id='.$row['id'].'&ac='.$ulp->random_string().'" title="'.__('Unblock campaign', 'ulp').'"><i class="fa fa-plus-square"></i></a>' : '<a href="'.admin_url('admin.php').'?action=ulp-campaigns-block&id='.$row['id'].'&ac='.$ulp->random_string().'" title="'.__('Block campaign', 'ulp').'"><i class="fa fa-minus-square"></i></a>').'
						<a href="'.admin_url('admin.php').'?action=ulp-campaigns-drop-counters&id='.$row['id'].'&ac='.$ulp->random_string().'" title="'.__('Drop counters', 'ulp').'" onclick="return ulp_confirm_redirect(this, \'reset-stats\');"><i class="fa fa-eraser"></i></a>
						<a href="'.admin_url('admin.php').'?action=ulp-campaigns-delete&id='.$row['id'].'&ac='.$ulp->random_string().'" title="'.__('Delete campaign', 'ulp').'" onclick="return ulp_confirm_redirect(this, \'delete\');"><i class="fa fa-trash"></i></a>
					</td>
				</tr>';
			}
		} else {
		...
		echo '
				...
				<div class="ulp_buttons">
					<a href="'.admin_url('admin.php').'?page=ulp-add-campaign" class="ulp-button ulp-button-small"><i class="fa fa-plus"></i><label>Create New Campaign</label></a>
				</div>
				<div class="ulp_pageswitcher">'.$switcher.'</div>
			</div>';
		echo $ulp->admin_modal_html();
	...
	function admin_subscribers() {
		...
		echo '
				...
				<div class="ulp_buttons"><a href="'.admin_url('admin.php').'?action=ulp-subscribers-csv'.((strlen($search_query) > 0) ? '&s='.rawurlencode($search_query) : '').($pid > 0 ? '&pid='.$pid : '').'&ac='.$ulp->random_string().'" class="ulp-button ulp-button-small"><i class="fa fa-download"></i><label>CSV Export</label></a></div>
				<div class="ulp_pageswitcher">'.$switcher.'</div>
				<table class="ulp_records">
				<tr>
					<th>'.__('Name', 'ulp').'</th>
		...
		if (sizeof($rows) > 0) {
			foreach ($rows as $row) {
				...
				<tr>
					...
					<td class="ulp-popups-actions">
						<a class="thickbox" href="'.admin_url('admin.php').'?action=ulp-subscribers-details&id='.$row['id'].'&ac='.$ulp->random_string().'" title="'.__('View details', 'ulp').'"><i class="fa fa-list-alt"></i></a>
						<a href="'.admin_url('admin.php').'?action=ulp-subscribers-delete&id='.$row['id'].((strlen($search_query) > 0) ? '&s='.rawurlencode($search_query) : '').($pid > 0 ? '&pid='.$pid : '').'&ac='.$ulp->random_string().'" title="'.__('Delete record', 'ulp').'" onclick="return ulp_confirm_redirect(this, \'delete\');"><i class="fa fa-trash"></i></a>
					</td>
				</tr>';
			}
		} else {
		...
		echo '
				...
				<div class="ulp_buttons">
					<a href="'.admin_url('admin.php').'?action=ulp-subscribers-delete-all'.((strlen($search_query) > 0) ? '&s='.rawurlencode($search_query) : '').($pid > 0 ? '&pid='.$pid : '').'&ac='.$ulp->random_string().'" onclick="return ulp_confirm_redirect(this, \'delete-all\');" class="ulp-button ulp-button-small"><i class="fa fa-trash"></i><label>Delete All</label></a>
					<a href="'.admin_url('admin.php').'?action=ulp-subscribers-csv'.((strlen($search_query) > 0) ? '&s='.rawurlencode($search_query) : '').($pid > 0 ? '&pid='.$pid : '').'&ac='.$ulp->random_string().'" class="ulp-button ulp-button-small"><i class="fa fa-download"></i><label>CSV Export</label></a>
				</div>
				<div class="ulp_pageswitcher">'.$switcher.'</div>
			</div>';
		echo $ulp->admin_modal_html();
