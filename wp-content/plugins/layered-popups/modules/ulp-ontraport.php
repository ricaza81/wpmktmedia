...
class ulp_ontraport_class {
	...
	function popup_options_show($_popup_options) {
		...
		echo '
							...
							<a class="ulp-button ulp-button-small" onclick="return ulp_ontraport_loadtags(this);"><i class="fa fa-check"></i><label>Load Tags</label></a>
		...
		echo '
							...
							<a class="ulp-button ulp-button-small" onclick="return ulp_ontraport_loadsequences(this);"><i class="fa fa-check"></i><label>Load Sequences</label></a>
		...
		echo '
							...
							<a class="ulp-button ulp-button-small" onclick="return ulp_ontraport_loadfields(this);"><i class="fa fa-check"></i><label>Load Fields</label></a>
...
<div class="ulp-ajax-multiselect" data-start="50" data-range="50" data-action="ulp-ontraport-tags-load" data-deps="ulp_ontraport_app_id,ulp_ontraport_api_key,ulp_ontraport_tags_selected" data-more="'.$more.'" onscroll="ulp_ajax_multiselect_scroll(this);">
	'.$html_selected.$html.'
	<div class="ulp-ajax-multiselect-loading"><i class="fa fa-spin fa-spinner"></i></div>
</div>';
		}
