			...
			<div id="ulp-aweber-connection">
				<table class="ulp_useroptions">
					...
					<tr>
						<th></th>
						<td>
							<a class="ulp-button ulp-button-small" onclick="return ulp_aweber_connect(this);"><i class="fa fa-check"></i><label>'.__('Connect to AWeber', 'ulp').'</label></a>
			...
			<div id="ulp-aweber-connection">
				<table class="ulp_useroptions">
					<tr>
						...
						<td>
							<a class="ulp-button ulp-button-small" onclick="return ulp_aweber_disconnect(this);"><i class="fa fa-close"></i><label>'.__('Disconnect from AWeber', 'ulp').'</label></a>
		...
		echo '
			<script>
				...
				function ulp_aweber_connect(_object) {
					...
					jQuery(_object).find("i").attr("class", "fa fa-spinner fa-spin");
					...
					jQuery.ajax({
						...
						success	: function(return_data) {
							jQuery(_object).find("i").attr("class", "fa fa-close");
...
<body>
	<div class="main-container">
		...
		<div class="button-container">
			<a class="button" data-href="https://auth.aweber.com/1.0/oauth/authorize_app/{app-id}" href="https://auth.aweber.com/1.0/oauth/authorize_app/'.ULP_AWEBER_APPID.'"><i class="fa fa-check"></i><label>Get Authorization Code</label></a>
		</div>
	</div>
</body>
</html>';
	...
	function popup_options_show($_popup_options) {
		...
		echo '
							...
							<a class="ulp-button ulp-button-small" onclick="return ulp_aweber_loadfields(this);"><i class="fa fa-download"></i><label>'.__('Load Fields', 'ulp').'</label></a>
							...
							<script>
								function ulp_aweber_loadfields(_object) {
									...
									ulp_saving = true;
									jQuery(_object).addClass("ulp-button-disabled");
									jQuery(_object).find("i").attr("class", "fa fa-spin fa-spinner");
									...
									jQuery.ajax({
										...
										success	: function(return_data) {
											jQuery(_object).removeClass("ulp-button-disabled");
											jQuery(_object).find("i").attr("class", "fa fa-check");
											var data;
											try {
