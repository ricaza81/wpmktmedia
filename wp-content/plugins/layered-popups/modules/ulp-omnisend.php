	...
	function popup_options_show($_popup_options) {
		...
		foreach ($popup_options['omnisend_custom_fields'] as $key => $value) {
			echo '									
									<tr>
										...
										<td style="vertical-align: middle;">
											'.($i > 0 ? '<a class="ulp-integration-row-remove" href="#" onclick="return ulp_omnisend_remove_fields(this);"><i class="fa fa-trash"></i></a>' : '').'
										</td>
									</tr>';
			$i++;
		}
		...
		echo '
									<tr style="display: none;" id="omnisend-fields-template">
										...
										<td style="vertical-align: middle;">
											<a class="ulp-integration-row-remove" href="#" onclick="return ulp_omnisend_remove_fields(this);"><i class="fa fa-trash"></i></a>
										</td>
									</tr>
									<tr>
										<td colspan="3">
											<a class="ulp-button ulp-button-small" onclick="return ulp_omnisend_add_fields(this);"><i class="fa fa-plus"></i><label>'.__('Add Custom Field', 'ulp').'</label></a>
										</td>
									</tr>
								</table>
							</div>
